...
set(POPLAR_TBB_DIR $ENV{POPLAR_SDK_ENABLED})
message("The value of POPLAR_TBB_DIR is " ${POPLAR_TBB_DIR})

foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    set(_tbb_release_lib "${POPLAR_TBB_DIR}/lib/lib${_tbb_component}.so.2")
    set(_tbb_debug_lib "${POPLAR_TBB_DIR}/lib/lib${_tbb_component}_debug.so.2")

    if (EXISTS "${_tbb_release_lib}" OR EXISTS "${_tbb_debug_lib}")
        add_library(TBB::${_tbb_component} SHARED IMPORTED)
        set_target_properties(TBB::${_tbb_component} PROPERTIES
                              INTERFACE_INCLUDE_DIRECTORIES "${POPLAR_TBB_DIR}/include/tbb")
